...
public class conection {
    ...
    public List<game> getPlayed_games(){
        ...
        try {
            ...
            while(res.next()){
                games.add(new game(res.getInt("id"), res.getInt("journal"), res.getString("teams"), res.getString("schedule"), res.getString("date"), res.getString("scorers")));
                System.out.print("Dato agregado");
            }
        } catch (SQLException e) {
            System.out.println("No existen datos");
    ...
    public void guardarTeam(team t){
        boolean band = false;
        try {
            Connection con = getConnection();
